...
final readonly class ExternalEffectFact
{
    public string $file;
    ...
    public function __construct(
        ...
        if ($startLine < 1 || $endLine < $startLine || trim($resource) === '') {
            throw new InvalidArgumentException('External effects require a resource and valid span.');
        }
